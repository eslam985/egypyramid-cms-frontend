    ...
    <div v-else-if="mediaStore.currentMedia" class="p-4 md:p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 pt-6">
        ...
        <div class="md:col-span-3 space-y-4">
          ...
          <!-- Labels -->
          <div v-if="mediaStore.currentMedia.labels" class="flex items-center gap-2 text-fluid-xs text-sub pt-1">
        ...
        <div class="md:col-span-1">
          <div class="aspect-2/3 rounded-xl overflow-hidden bg-line/10 border border-line relative shadow-soft">
