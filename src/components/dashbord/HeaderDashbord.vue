...
<template>
    <main class="space-y-6">
        ...
        <div class="flex items-center justify-between flex-wrap gap-3">
            <div>
                <h1 class="text-fluid-h2 font-bold text-main">لوحة التحكم والتحليلات</h1>
                <p class="text-fluid-xs text-sub mt-1">نظرة عامة على حالة النظام، الروابط، والأعمال غير المكتملة.</p>
            </div>
