...
// ✅ ده اللي كان ناقص - بيثبت الثيم واللغة لكل الصفحات
onMounted(() => {
  ...
  // وبتاع الـ dir اللي صلحناه المرة اللي فاتت
...
<template>
  ...
  >
    <div
      class="w-12 h-12 border-4 border-gray-200 border-t-blue-500 rounded-full animate-spin mb-5"
    ></div>
