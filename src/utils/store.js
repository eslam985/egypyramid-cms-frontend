...
export async function handleStoreDelete({
    store,apiCall,id,listKey,idKey = 'id',defaultError = 'حدث خطأ أثناء الحذف'
}) {
...
export async function handleStoreEdit ({
    store, apiCall, id, data, listKey, idKey = 'id',  defaultError = 'حدث خطأ اثناء التعديل!'
}) {
    store.isLoading = true
    store.successMessage = ''
    store.errorMessage = ''
...
export async function handleStoreAdd({
    store, apiCall, id, data, listKey, defaultError = 'حدث خطأ اثناء الإضافة!'
}) {
    store.isLoading = true
    store.successMessage = ''
    store.errorMessage = ''
